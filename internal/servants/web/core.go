...
func (s *coreSrv) SyncSearchIndex(c context.Context, req *web.SyncSearchIndexReq) mir.Error {
...
func (s *coreSrv) GetUserInfo(c context.Context, req *web.UserInfoReq) (*web.UserInfoResp, mir.Error) {
...
func (s *coreSrv) GetMessages(c context.Context, req *web.GetMessagesReq) (res *web.GetMessagesResp, _ mir.Error) {
	limit, offset := req.PageSize, (req.Page-1)*req.PageSize
	// 尝试直接从缓存中获取数据
	key, ok := "", false
	if res, key, ok = s.messagesFromCache(c, req, limit, offset); ok {
	...
	for _, mf := range messages {
		...
		if mf.SenderUserID > 0 {
			if user, err := s.Ds.GetUserByID(c, mf.SenderUserID); err == nil {
				mf.SenderUser = user.Format()
			}
		}
		if mf.Type == ms.MsgTypeWhisper && mf.ReceiverUserID != req.Uid {
			if user, err := s.Ds.GetUserByID(c, mf.ReceiverUserID); err == nil {
...
func (s *coreSrv) ReadMessage(c context.Context, req *web.ReadMessageReq) mir.Error {
...
func (s *coreSrv) ReadAllMessage(c context.Context, req *web.ReadAllMessageReq) mir.Error {
...
func (s *coreSrv) SendUserWhisper(c context.Context, req *web.SendWhisperReq) mir.Error {
	// 不允许发送私信给自己
...
func (s *coreSrv) GetCollections(c context.Context, req *web.GetCollectionsReq) (*web.GetCollectionsResp, mir.Error) {
...
func (s *coreSrv) UserPhoneBind(c context.Context, req *web.UserPhoneBindReq) mir.Error {
	// 手机重复性检查
...
func (s *coreSrv) GetStars(c context.Context, req *web.GetStarsReq) (*web.GetStarsResp, mir.Error) {
...
func (s *coreSrv) ChangePassword(c context.Context, req *web.ChangePasswordReq) mir.Error {
	// 密码检查
...
func (s *coreSrv) SuggestTags(c context.Context, req *web.SuggestTagsReq) (*web.SuggestTagsResp, mir.Error) {
...
func (s *coreSrv) SuggestUsers(c context.Context, req *web.SuggestUsersReq) (*web.SuggestUsersResp, mir.Error) {
...
func (s *coreSrv) ChangeNickname(c context.Context, req *web.ChangeNicknameReq) mir.Error {
...
func (s *coreSrv) ChangeAvatar(c context.Context, req *web.ChangeAvatarReq) (xerr mir.Error) {
	defer func() {
		if xerr != nil {
...
func (s *coreSrv) TweetCollectionStatus(c context.Context, req *web.TweetCollectionStatusReq) (*web.TweetCollectionStatusResp, mir.Error) {
...
func (s *coreSrv) TweetStarStatus(c context.Context, req *web.TweetStarStatusReq) (*web.TweetStarStatusResp, mir.Error) {
...
func (s *coreSrv) messagesFromCache(c context.Context, req *web.GetMessagesReq, limit int, offset int) (res *web.GetMessagesResp, key string, ok bool) {
