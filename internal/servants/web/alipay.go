...
func (s *alipayPubSrv) AlipayNotify(c context.Context, req *web.AlipayNotifyReq) mir.Error {
...
func (s *alipayPrivSrv) UserWalletBills(c context.Context, req *web.UserWalletBillsReq) (*web.UserWalletBillsResp, mir.Error) {
...
func (s *alipayPrivSrv) UserRechargeLink(c context.Context, req *web.UserRechargeLinkReq) (*web.UserRechargeLinkResp, mir.Error) {
...
func (s *alipayPrivSrv) UserRechargeResult(c context.Context, req *web.UserRechargeResultReq) (*web.UserRechargeResultResp, mir.Error) {
	recharge, err := s.Ds.GetRechargeByID(req.Id)
	if err != nil {
