...
func (s *privSrv) ThumbsDownTweetReply(c context.Context, req *web.TweetReplyThumbsReq) mir.Error {
...
func (s *privSrv) ThumbsUpTweetReply(c context.Context, req *web.TweetReplyThumbsReq) mir.Error {
...
func (s *privSrv) ThumbsDownTweetComment(c context.Context, req *web.TweetCommentThumbsReq) mir.Error {
...
func (s *privSrv) ThumbsUpTweetComment(c context.Context, req *web.TweetCommentThumbsReq) mir.Error {
...
func (s *privSrv) UnfollowTopic(c context.Context, req *web.UnfollowTopicReq) mir.Error {
...
func (s *privSrv) FollowTopic(c context.Context, req *web.FollowTopicReq) mir.Error {
...
func (s *privSrv) StickTopic(c context.Context, req *web.StickTopicReq) (*web.StickTopicResp, mir.Error) {
...
func (s *privSrv) PinTopic(c context.Context, req *web.PinTopicReq) (*web.PinTopicResp, mir.Error) {
...
func (s *privSrv) UploadAttachment(c context.Context, req *web.UploadAttachmentReq) (*web.UploadAttachmentResp, mir.Error) {
...
func (s *privSrv) DownloadAttachmentPrecheck(c context.Context, req *web.DownloadAttachmentPrecheckReq) (*web.DownloadAttachmentPrecheckResp, mir.Error) {
...
func (s *privSrv) DownloadAttachment(c context.Context, req *web.DownloadAttachmentReq) (*web.DownloadAttachmentResp, mir.Error) {
	content, err := s.Ds.GetPostContentByID(req.ContentID)
	if err != nil {
...
func (s *privSrv) CreateTweet(c context.Context, req *web.CreateTweetReq) (_ *web.CreateTweetResp, xerr mir.Error) {
...
func (s *privSrv) DeleteTweet(c context.Context, req *web.DeleteTweetReq) mir.Error {
	if req.User == nil {
...
func (s *privSrv) DeleteCommentReply(c context.Context, req *web.DeleteCommentReplyReq) mir.Error {
...
func (s *privSrv) CreateCommentReply(c context.Context, req *web.CreateCommentReplyReq) (_ *web.CreateCommentReplyResp, xerr mir.Error) {
	var (
		post     *ms.Post
		comment  *ms.Comment
		atUserID int64
	...
	// 创建用户消息提醒
	commentMaster, err := s.Ds.GetUserByID(c, comment.UserID)
	...
	postMaster, err := s.Ds.GetUserByID(c, post.UserID)
	...
	if atUserID > 0 {
		user, err := s.Ds.GetUserByID(c, atUserID)
...
func (s *privSrv) DeleteComment(c context.Context, req *web.DeleteCommentReq) mir.Error {
...
func (s *privSrv) HighlightComment(c context.Context, req *web.HighlightCommentReq) (*web.HighlightCommentResp, mir.Error) {
...
func (s *privSrv) CreateComment(c context.Context, req *web.CreateCommentReq) (_ *web.CreateCommentResp, xerr mir.Error) {
	var (
...
func (s *privSrv) CollectionTweet(c context.Context, req *web.CollectionTweetReq) (*web.CollectionTweetResp, mir.Error) {
	status := false
...
func (s *privSrv) StarTweet(c context.Context, req *web.StarTweetReq) (*web.StarTweetResp, mir.Error) {
	status := false
...
func (s *privSrv) VisibleTweet(c context.Context, req *web.VisibleTweetReq) (*web.VisibleTweetResp, mir.Error) {
...
func (s *privSrv) StickTweet(c context.Context, req *web.StickTweetReq) (*web.StickTweetResp, mir.Error) {
	post, err := s.Ds.GetPostByID(req.ID)
	if err != nil {
...
func (s *privSrv) HighlightTweet(c context.Context, req *web.HighlightTweetReq) (res *web.HighlightTweetResp, err mir.Error) {
...
func (s *privSrv) LockTweet(c context.Context, req *web.LockTweetReq) (*web.LockTweetResp, mir.Error) {
	post, err := s.Ds.GetPostByID(req.ID)
	if err != nil {
