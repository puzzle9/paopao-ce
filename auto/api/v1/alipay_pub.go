...
type AlipayPub interface {
	...
	AlipayNotify(context.Context, *web.AlipayNotifyReq) mir.Error
...
func RegisterAlipayPubServant(e *gin.Engine, s AlipayPub) {
	...
	router.Handle("POST", "/alipay/notify", func(c *gin.Context) {
		...
		s.Render(c, nil, s.AlipayNotify(c.Request.Context(), req))
	})
}
...
func (UnimplementedAlipayPubServant) AlipayNotify(c context.Context, req *web.AlipayNotifyReq) mir.Error {
