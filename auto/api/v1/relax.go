...
type Relax interface {
	...
	GetUnreadMsgCount(context.Context, *web.GetUnreadMsgCountReq) (*web.GetUnreadMsgCountResp, mir.Error)
...
func RegisterRelaxServant(e *gin.Engine, s Relax, m ...RelaxChain) {
	...
	router.Handle("GET", "/user/msgcount/unread", append(cc.ChainGetUnreadMsgCount(), func(c *gin.Context) {
		...
		resp, err := s.GetUnreadMsgCount(c.Request.Context(), req)
		if err != nil {
			s.Render(c, nil, err)
			return
		}
...
func (UnimplementedRelaxServant) GetUnreadMsgCount(c context.Context, req *web.GetUnreadMsgCountReq) (*web.GetUnreadMsgCountResp, mir.Error) {
