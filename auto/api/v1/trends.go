...
type Trends interface {
	...
	GetIndexTrends(context.Context, *web.GetIndexTrendsReq) (*web.GetIndexTrendsResp, mir.Error)
...
func RegisterTrendsServant(e *gin.Engine, s Trends) {
	...
	router.Handle("GET", "/trends/index", func(c *gin.Context) {
		...
		resp, err := s.GetIndexTrends(c.Request.Context(), req)
		if err != nil {
			s.Render(c, nil, err)
			return
		}
...
func (UnimplementedTrendsServant) GetIndexTrends(c context.Context, req *web.GetIndexTrendsReq) (*web.GetIndexTrendsResp, mir.Error) {
